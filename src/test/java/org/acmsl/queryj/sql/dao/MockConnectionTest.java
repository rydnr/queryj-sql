...
import org.acmsl.queryj.sql.dao.MockConnection;
...
* @see org.acmsl.queryj.sql.dao.MockConnection
*/
...
// JUnitDoclet end extends_implements
{
  ...
  @Nullable
  org.acmsl.queryj.sql.dao.MockConnection mockconnection = null;
  ...
  */
  @Nullable
  public org.acmsl.queryj.sql.dao.MockConnection createInstance()
  throws Exception
  {
    // JUnitDoclet begin method testcase.createInstance
    return new org.acmsl.queryj.sql.dao.MockConnection(null, null);
  ...
  * @throws Exception if an unexpected situation occurs.
  * @see org.acmsl.queryj.sql.dao.MockConnection#getConnection()
  */
  ...
  * @throws Exception if an unexpected situation occurs.
  * @see org.acmsl.queryj.sql.dao.MockConnection#getMockDataSource()
  */
  ...
  * @throws Exception if an unexpected situation occurs.
  * @see org.acmsl.queryj.sql.dao.MockConnection#clearWarnings()
  */
  ...
  * @throws Exception if an unexpected situation occurs.
  * @see org.acmsl.queryj.sql.dao.MockConnection#close()
  */
  ...
  * @throws Exception if an unexpected situation occurs.
  * @see org.acmsl.queryj.sql.dao.MockConnection#commit()
  */
  ...
  * @throws Exception if an unexpected situation occurs.
  * @see org.acmsl.queryj.sql.dao.MockConnection#createStatement()
  */
  ...
  * @throws Exception if an unexpected situation occurs.
  * @see org.acmsl.queryj.sql.dao.MockConnection#getMetaData()
  */
  ...
  * @throws Exception if an unexpected situation occurs.
  * @see org.acmsl.queryj.sql.dao.MockConnection#getWarnings()
  */
  ...
  * @throws Exception if an unexpected situation occurs.
  * @see org.acmsl.queryj.sql.dao.MockConnection#isClosed()
  */
  ...
  * @throws Exception if an unexpected situation occurs.
  * @see org.acmsl.queryj.sql.dao.MockConnection#nativeSQL(java.lang.String)
  */
  ...
  * @throws Exception if an unexpected situation occurs.
  * @see org.acmsl.queryj.sql.dao.MockConnection#prepareCall(java.lang.String)
  */
  ...
  * @throws Exception if an unexpected situation occurs.
  * @see org.acmsl.queryj.sql.dao.MockConnection#prepareStatement(java.lang.String)
  */
  ...
  * @throws Exception if an unexpected situation occurs.
  * @see org.acmsl.queryj.sql.dao.MockConnection#rollback()
  */
  ...
  */
  ...
  throws Exception
  {
      ...
      @NotNull final java.util.Map[] t_aTests = {new java.util.HashMap(), null};
    
      for (int t_iTestIndex = 0; t_iTestIndex < t_aTests.length; t_iTestIndex++)
      {
          mockconnection.setTypeMap(t_aTests[t_iTestIndex]);
          assertEquals(t_aTests[t_iTestIndex], mockconnection.getTypeMap());
      }
  ...
  */
  ...
  throws Exception
  {
      ...
      for (int t_iTestIndex = 0; t_iTestIndex < t_aTests.length; t_iTestIndex++)
      {
          assertNotNull(t_aTests[t_iTestIndex]);
          mockconnection.setHoldability(t_aTests[t_iTestIndex]);
          assertEquals(t_aTests[t_iTestIndex], mockconnection.getHoldability());
      }
  ...
  * @throws Exception if an unexpected situation occurs.
  * @see org.acmsl.queryj.sql.dao.MockConnection#setSavepoint()
  */
  ...
  * @throws Exception if an unexpected situation occurs.
  * @see org.acmsl.queryj.sql.dao.MockConnection#releaseSavepoint(java.sql.Savepoint)
  */
